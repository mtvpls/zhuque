...
pub fn create_router(state: Arc<AppState>) -> Router {
    ...
    let protected_routes = Router::new()
        ...
        .route("/api/remote/agents/:id", get(remote::get_agent).delete(remote::delete_agent))
        .route("/api/remote/agents/:id/token", post(remote::regenerate_agent_token))
        ...
        .route("/api/remote/agents/:id/terminal/connect", get(remote::connect_terminal))
